...
/**
 * Controls the descriptor widgets for a legacy application.
 */
public class LegacyApplicationDescriptorControl extends ApplicationDescriptorControl {
    ...
    public LegacyApplicationDescriptorControl(Section applicationSection,
        ...
        UpdateValueStrategy<String, String> updateUrlStrategy = updateValueStrategy()
                .withConverter(IConverter.<String, String> create(this::getUrlToDisplay))
                .create();

        IObservableValue<String> observeLinkText = PojoProperties.value("text", String.class).observe(link);
        ...
        ctx.bindValue(imageToolTipObservable, homePageObservable,
                ...
                updateValueStrategy()
                        .withConverter(IConverter
                                .<String, String> create(s -> applicationNavigation.validateHomePageToken(s).isOK() ? ""
        ...
        ctx.bindValue(WidgetProperties.enabled().observe(link), homePageObservable,
                ...
                updateValueStrategy()
                        .withConverter(IConverter
                                .<String, Boolean> create(s -> applicationNavigation.validateHomePageToken(s).isOK()))
                        .create());
    }
        ...
        try {
            ...
            return !(applicationAPI.searchApplications(new SearchOptionsBuilder(0, 1)
                    ...
                    pageAPI.searchPages(new SearchOptionsBuilder(0, 1)
                            .filter(PageSearchDescriptor.NAME, resolveToken(application, application.getHomePage()))
                            .done())
                            .getCount() > 0);
